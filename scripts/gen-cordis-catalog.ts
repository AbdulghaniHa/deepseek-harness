...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  BrowserOpenTabRequest: 'browser.md',
  BrowserCdpRequest: 'browser.md',
  ...
  BrowserHistoryItem: 'browser.md',
  BrowserBookmarkItem: 'browser.md',
  BrowserReadingListItem: 'browser.md',
  BrowserDownloadItem: 'browser.md',
  BrowserDownloadId: 'browser.md',
  BrowserStatus: 'browser.md',
  BrowserFrame: 'browser.md',
  BrowserFrameId: 'browser.md',
  ComputerProvider: 'computer-use.md',
  ComputerWindow: 'computer-use.md',
  ComputerWindowId: 'computer-use.md',
  ComputerDisplay: 'computer-use.md',
  ComputerDisplayId: 'computer-use.md',
  ComputerPoint: 'computer-use.md',
  ComputerRect: 'computer-use.md',
  ComputerSnapshotNode: 'computer-use.md',
  ComputerScreenshotRequest: 'computer-use.md',
  ComputerCapability: 'computer-use.md',
  ComputerPermissions: 'computer-use.md',
  ComputerApp: 'computer-use.md',
  ComputerAppId: 'computer-use.md',
  ComputerGrantScope: 'computer-use.md',
  ComputerGrant: 'computer-use.md',
  ComputerLaunchRequest: 'computer-use.md',
  ComputerSnapshot: 'computer-use.md',
  ComputerSnapshotRequest: 'computer-use.md',
  ComputerScreenshot: 'computer-use.md',
  ComputerClickRequest: 'computer-use.md',
  ComputerKeyRequest: 'computer-use.md',
  ComputerKeyAction: 'computer-use.md',
  ComputerScrollRequest: 'computer-use.md',
  ComputerDragRequest: 'computer-use.md',
  ComputerStatus: 'computer-use.md',
  ComputerActionRequest: 'computer-use.md',
  ComputerA11yAction: 'computer-use.md',
