...
export const zh = {
  ...
  'tool.title.browser': '浏览器',
  'tool.browser.untitled': '无标题页面',
  'tool.browser.preview': '浏览器预览',
  'tool.browser.unavailable': '预览不可用。请检查 Chrome 连接和标签页，然后重试。',
  'tool.browser.refreshing': '正在刷新',
  'tool.browser.live': '实时预览',
  'tool.browser.captured': '已捕获',
  'tool.browser.collapse': '缩小预览',
  'tool.browser.expand': '展开预览',
  'tool.browser.refresh': '刷新',
  'tool.browser.pause': '暂停预览',
  'tool.browser.reveal': '在 Chrome 中显示',
  'tool.browser.revealFailed': '无法显示标签页。它可能已关闭。',
  'tool.title.computer': '电脑',
  'tool.computer.untitled': '无标题窗口',
...
export const en = {
  ...
  'tool.title.browser': 'Browser',
  'tool.browser.untitled': 'Untitled page',
  'tool.browser.preview': 'Browser preview',
  'tool.browser.unavailable': 'Preview unavailable. Check the Chrome connection and tab, then retry.',
  'tool.browser.refreshing': 'Refreshing',
  'tool.browser.live': 'Live preview',
  'tool.browser.captured': 'Captured',
  'tool.browser.collapse': 'Collapse preview',
  'tool.browser.expand': 'Expand preview',
  'tool.browser.refresh': 'Refresh',
  'tool.browser.pause': 'Pause preview',
  'tool.browser.reveal': 'Show in Chrome',
  'tool.browser.revealFailed': 'Could not reveal the tab. It may be closed.',
  'tool.title.computer': 'Computer',
  'tool.computer.untitled': 'Untitled window',
