...
| [`browser/`](browser/README.zh.md) | 浏览器能力系列：seam、Chrome Native Messaging 提供方、面向模型的浏览器工具 |
| [`computer-use/`](computer-use/README.zh.md) | 电脑操控能力系列：seam、本地 helper 提供方、面向模型的 computer 工具 |
