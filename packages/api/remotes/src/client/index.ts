...
import browserRemote from '@deepseek-ai/dsh-browser/remote'
...
export type {} from '@deepseek-ai/dsh-browser/remote'
export type { BrowserPreview, BrowserTabId } from '@deepseek-ai/dsh-browser/client'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      subagentsRemote, sessionRemote, workspaceRemote, browserRemote, workspaceFilesRemote,
    ]) {
