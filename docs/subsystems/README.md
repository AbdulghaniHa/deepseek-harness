...
| [browser.md](browser.md) | the browser seam: `BrowserProvider`, owner-scoped attachments, CDP relay, Chrome-API facets, `BrowserError` |
| [computer-use.md](computer-use.md) | the computer-use seam: `ComputerProvider`, grants, deny list, hit-testing, `ComputerError` |
