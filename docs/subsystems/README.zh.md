...
| [browser.md](browser.zh.md) | 浏览器 seam：`BrowserProvider`、按 owner 限定的附件、CDP 中继、Chrome API 侧面、`BrowserError` |
| [computer-use.md](computer-use.zh.md) | 电脑操控 seam：`ComputerProvider`、授权、拒绝列表、命中测试、`ComputerError` |
