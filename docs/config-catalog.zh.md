...
来源：[`packages/computer-use/computer-use-local/src/index.ts:42`](../packages/computer-use/computer-use-local/src/index.ts)
...
需要：`tools` · `computer` · `systemPrompt`
...
来源：[`packages/computer-use/tool-computer-use/src/index.ts:64`](../packages/computer-use/tool-computer-use/src/index.ts)
